...
contract testSuite is Donations {
    ...
    function donateAcc1AndCheckBalance() public payable{
        ...
        Assert.equal(balancesGetter(recipient), 1000000000000000000, 'balances should be 1 Eth');
    }
    ...
    function donateAcc2AndCheckBalance() public payable{
        ...
        Assert.equal(balancesGetter(recipient), 2000000000000000000, 'balances should be 2 Eth');
    }
    ...
    function donateAcc3AndCheckBalance() public payable{
        ...
        Assert.equal(balancesGetter(recipient), 4000000000000000000, 'balances should be 4 Eth');
    }
